...
class Peserta extends Model
{
    ...
    public function detail_peserta($id){
        return Peserta::join('tbl_lagu', 'tbl_lagu.id_lagu', '=', 'tbl_register.id_lagu')
                    ...
                    ->select('tbl_register.id_register as idr','tbl_register.lagu_wajib','tbl_register.no_tampil', 'tbl_lagu.genre as jenis_lagu','tbl_njemaat.nama as nama_jemaat','tbl_njemaat.id_njemaat as idj', 
                    'tbl_lagu.judul as judul_lagu', 'tbl_kategori_lomba.kategori_lomba','tbl_kategori_lomba.id_kategori_lomba as idk','tbl_register.kordinator','tbl_register.phone',
