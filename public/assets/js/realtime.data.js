            ...
            success: function(response) {
                ...
                $.each(response.data, function(key, view) {
                    ...
                    var row = `<tr>
                        ...
                        ${view.juri.map(juri => `<img src="https://shanibacreative.com/wp-content/uploads/2020/06/membuat-foto-profil-yang-bagus.jpg" alt="${juri.name}" class="rounded-circle" width="30" height="30">`).join(' ')}
                        </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
